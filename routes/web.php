...
Route::middleware(['client', 'status'])->group(function () {
    ...
    Route::get('/client/order/pending-to-confirm/{id}', [ManageOrderController::class, 'ClientPendingToConfirm'])->name('client.pending.to.confirm');
    Route::get('/client/order/confirm-to-processing/{id}', [ManageOrderController::class, 'ClientConfirmToProcessing'])->name('client.confirm.to.processing');
    Route::get('/client/order/processing-to-delivered/{id}', [ManageOrderController::class, 'ClientProcessingToDelivered'])->name('client.processing.to.delivered');
...
Route::controller(CartController::class)->group(function () {
    ...
    Route::post('/apply-coupon', 'ApplyCoupon')->name('coupon.apply'); // ✅ fixed
    Route::get('/remove-coupon', 'CouponRemove')->name('coupon.remove'); // ✅ fixed
