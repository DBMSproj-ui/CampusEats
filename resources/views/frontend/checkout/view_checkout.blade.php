...
@section('dashboard')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const checkoutForms = document.querySelectorAll("form[action='{{ route('cash_order') }}']");
                ...
                form.addEventListener("submit", function(e) {
                    ...
                    if (!userAddress || userAddress.trim() === '') {
                        ...
                        Swal.fire({
                            ...
                            text: 'Please update your profile with your delivery address before placing the order.',
                ...
                <div class="col-md-8">
                    <div class="offer-dedicated-body-left">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="mb-0 text-black font-weight-bold">
                                                        <a class="btn btn-sm btn-success mr-2" href="#">DELIVER
                                                            HERE</a>
                                                        <span>30MIN</span>
                                                    </p>
                                                </div>
                                        ...
                                        <div class="gold-members p-4">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p>GPS based</p>
                                                    <p class="mb-0 text-black font-weight-bold">
                                                        <a class="btn btn-sm btn-secondary mr-2" href="#">DELIVER
                                                            HERE</a>
                                                        <span>X MIN</span>
                                                    </p>
                                                </div>
                        ...
                        <div class="bg-white rounded shadow-sm p-4 osahan-payment">
                            ...
                            <h6 class="mb-3 text-black-50">Cash on delivery / cards</h6>
                            <div class="row">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-cash" role="tabpanel"
                                            ...
                                            <form action="{{ route('cash_order') }}" method="post">
                                                ...
                                                <button type="submit" class="btn btn-success btn-block btn-lg">
                                                    PAY <i class="icofont-long-arrow-right"></i>
                                                </button>
                                            </form>
                                        </div>
                        ...
                        @if (Session::has('coupon'))
                            <div class="mb-2 bg-white rounded p-2 clearfix">
                                ...
                                <p class="mb-1 text-success">Total Discount <span
                                        class="float-right text-success">₹{{ $total - session()->get('coupon')['discount_amount'] }}</span>
                                </p>
                                <hr />
                                <h6 class="font-weight-bold mb-0">TO PAY <span
                                        class="float-right">₹{{ session()->get('coupon')['discount_amount'] }}</span></h6>
                            </div>
                        @else
                            <div class="mb-2 bg-white rounded p-2 clearfix">
