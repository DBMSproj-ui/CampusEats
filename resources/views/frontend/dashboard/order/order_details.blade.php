                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @elseif ($order->status == 'processing')
                                                                        <span class="badge bg-primary">Out for
                                                                            Delivery</span>
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        @foreach ($orderItem as $item)
                                                            <tr>
                                                                <td><img src="{{ asset($item->product->image) }}"
                                                                        style="width:50px; height:50px"></td>
                                                                <td>{{ $item->product->name }}</td>
                                                                <td>{{ $item->client_id == null ? 'Owner' : $item->product->client->name }}
                                                                </td>
                                                        ...
                                                        <tr>
                                                            <td colspan="5" class="text-end"><strong>Final
                                                                    Price:</strong></td>
