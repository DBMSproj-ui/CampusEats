<section class="section pt-5 pb-5 text-center bg-white">
    <div class="container">
       <div class="row">
          <div class="col-sm-12">
             <h5 class="m-0">Operate food store or restaurants? <a href="/client/register">Work With Us</a></h5>
          </div>
       </div>
    </div>
</section>
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-4 col-12 col-sm-12">
            ...
            <p class="mb-1 text-muted">For inquiries or support, feel free to reach out:</p>
            <p><strong>Email:</strong> <a href="mailto:support@campuseats.com" class="text-info">support@campuseats.com</a></p>
         </div>

         <div class="col-md-1 col-sm-6 mobile-none">
         </div>
         <div class="col-md-2 col-6 col-sm-4">
            <h6 class="mb-3">About CE</h6>
            <ul>
...
<footer class="pt-4 pb-4 text-center">
    <div class="container">
        <p class="mt-0 mb-0">© Copyright 2025 CampusEats. All Rights Reserved</p>
        <small class="mt-0 mb-0">
            Made with <i class="fas fa-heart heart-icon text-danger"></i>
        </small>
    </div>
</footer>
