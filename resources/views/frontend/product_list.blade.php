...
<div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
    <div class="list-card-image">
        <div class="star position-absolute"><span class="badge badge-success"><i class="icofont-star"></i> 4.0 (20+)</span></div>
    ...
    <div class="p-3 position-relative">
        ...
        <span class="badge badge-success">OFFER</span> <small>15% off | Use Coupon CmpEat50</small>
        </div>
    </div>
</div>
</div>    
