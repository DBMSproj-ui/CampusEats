...
<div class="navbar-brand-box">
    <a href="{{ route('client.dashboard') }}" class="logo logo-dark">
        <span class="logo-sm">
            <i data-feather="coffee" style="font-size: 24px;"></i>
        </span>
        <span class="logo-lg">
            <i data-feather="coffee" style="font-size: 24px;"></i> 
    ...
    <div class="dropdown-menu dropdown-menu-end p-2" aria-labelledby="page-header-notifications-dropdown">
        <h6 class="m-0 text-center">Notifications</h6>
    </div>
</div>
